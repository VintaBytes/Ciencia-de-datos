...
**Introducción al aprendizaje no supervisado mediante el algoritmo K-Means.** Esta parte del recorrido muestra distintos usos de K-Means: primero con datos preparados para comprender la lógica del algoritmo, luego con datos reales donde aparecen limitaciones, y finalmente en un caso de segmentación de clientes:
